...
description: Create a deep research prompt document for investigating a technical domain. Use when the user wants to explore how to build something, evaluate approaches, or understand a complex technical space before committing to an implementation.
...
- User wants to explore a technical domain before building
- User needs to evaluate multiple approaches to a problem
- User wants to understand how production systems handle something
- User is planning a major architectural decision
